...
def build_dict(step, train_article_path, train_title_path, toy=False):
    if step == "train":
...
def build_dataset(step, word_dict, article_max_len, summary_max_len, train_article_path, train_title_path, valid_article_path, valid_title_path, toy=False):
    if step == "train":
